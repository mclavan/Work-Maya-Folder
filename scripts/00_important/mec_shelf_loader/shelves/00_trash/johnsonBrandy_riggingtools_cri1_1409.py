'''
johnsonBrandy_riggingtools_cri1_1409.py
Brandy Johnson
...
import johnsonBrandy_riggingtools_cri1_1409
reload(johnsonBrandy_riggingtools_cri1_1409)
...
def hierarchy():
	...
	import johnsonBrandy_riggingtools_cri1_1409
	johnsonBrandy_riggingtools_cri1_1409.hierarchy()
	'''
	...
	control_icon_1 = pm.circle(normal=[1, 0, 0], radius=1, name='lt_middle_01_icon')[0]
	...
	print 'Local Pad 1 CreatedL:', local_pad_1
	...
	# Create a control.
	# normal=[1, 0, 0], radius=1
	control_icon_2 = pm.circle(normal=[1, 0, 0], radius=1, name='lt_middle_02_icon')[0]
	...
	print 'Local Pad 2 CreatedL:', local_pad_2
	...
	# Create a control.
	# normal=[1, 0, 0], radius=1
	control_icon_3 = pm.circle(normal=[1, 0, 0], radius=1, name='lt_middle_03_icon')[0]
	...
	print 'Local Pad 3 CreatedL:', local_pad_3
...
def joint_renamer():
	...
	How to Run:
		...
		import johnsonBrandy_riggingtools_cri1_1409
		reload(johnsonBrandy_riggingtools_cri1_1409)
		johnsonBrandy_riggingtools_cri1_1409.joint_renamer()
	'''
	...
	'''
	for curret_joint in joint_chain:
		new_name = '{0}_{1}_0{2}_{3}'.format(ori, system_name, count, suffix)
		print 'New Name:', new_name 

		# Rename joint
		curret_joint.rename(new_name)
		count = count + 1
...
def padding_tool():
	...
	How to Run:
		...
		import johnsonBrandy_riggingtools_cri1_1409
		reload(johnsonBrandy_riggingtools_cri1_1409)
		johnsonBrandy_riggingtools_cri1_1409.padding_tool()
	'''
...
def priming_tool():
	...
	import johnsonBrandy_riggingtools_cri1_1409
	reload(johnsonBrandy_riggingtools_cri1_1409)
	johnsonBrandy_riggingtools_cri1_1409.priming_tool()
	'''
	...
	for target_joint in selected:
		...
		# Create control
		# normal set to x and radius is 1
