'''
dattaloVincent_rigging_tools_cri_1409.py
Vincent Dattalo
...
import dattaloVincent_rigging_tools_cri_1409
reload(dattaloVincent_rigging_tools_cri_1409)
...
def hierarchy():
	...
	import dattaloVincent_rigging_tools_cri_1409
	dattaloVincent_rigging_tools_cri_1409.hierarchy()
	'''
...
def joint_renamer():
	...
	How to Run:
		...
		import dattaloVincent_rigging_tools_cri_1409
		reload(dattaloVincent_rigging_tools_cri_1409)
		dattaloVincent_rigging_tools_cri_1409.joint_renamer()
	'''
...
def padding_tool():
	...
	How to Run:
		...
		import dattaloVincent_rigging_tools_cri_1409
		reload(dattaloVincent_rigging_tools_cri_1409)
		dattaloVincent_rigging_tools_cri_1409.padding_tool()
	'''
...
def priming_tool():
	...
	import dattaloVincent_rigging_tools_cri_1409
	reload(dattaloVincent_rigging_tools_cri_1409)
	dattaloVincent_rigging_tools_cri_1409.priming_tool()
	'''
