...
def chapter_1():
	print 'Chapter 1'
	print 'It is the best of times.  It was the worst of times.'


def chapter_27():
	print 'Chapter 27 - The end game.'
...
def create_controls():
	'''
	Description:
		Create multiple icons and position in the scene. 

	Instruction:
		import functions_01
		functions_01.create_controls()
	'''

	print 'Control icons created and positioned.'
