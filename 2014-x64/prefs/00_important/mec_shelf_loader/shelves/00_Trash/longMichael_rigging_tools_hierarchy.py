...
def function(*args):
    ...
    print
    print 'hierarchy.function() has been activated'
    print

    hierarchyCreator()

def hierarchyCreator(*args):
    # Creates/Names/Organizes new control icons and groups

    print
    print 'hierarchy.hierarchyCreator() has been activated'
    print
...
# Line 205 is not indented correctly.            
    ...
    world_group = pm.group(name = 'HierarchyProject_world', em=True)
    ...
    # Print statments in editor. For debugging
    print
    print 'Empty Group Created: ', world_group
    print
    ...
    #   ---> pads/controls group
    #   ---> jointPad_group
    pm.parent(jointPad_group, world_group)
    pm.parent(parentPad, world_group)
