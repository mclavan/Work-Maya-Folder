'''
Angel Ochoa
ochoaAngel_riggingTools_cri1_1405.py
...
import ochoaAngel_riggingTools_cri1_1405
reload(ochoaAngel_riggingTools_cri1_1405)
...
def padding_tool():
	...
	import ochoaAngel_riggingTools_cri1_1405
	reload (ochoaAngel_riggingTools_cri1_1405)
	ochoaAngel_riggingTools_cri1_1405.padding_tool()
	'''
...
def joint_renamer():
	...
	import ochoaAngel_riggingTools_cri1_1405
	reload (ochoaAngel_riggingTools_cri1_1405)
	ochoaAngel_riggingTools_cri1_1405.joint_renamer()
	'''
...
def priming_tool():
	...
	import ochoaAngel_riggingTools_cri1_1405
	reload (ochoaAngel_riggingTools_cri1_1405)
	ochoaAngel_riggingTools_cri1_1405.priming_tool()
	'''
...
def lock_hide_attr():
	...
	import ochoaAngel_riggingTools_cri1_1405
	reload (ochoaAngel_riggingTools_cri1_1405)
	ochoaAngel_riggingTools_cri1_1405.lock_hide_attr()
	'''
	...
	print 'Attributes Hidden and Locked'
